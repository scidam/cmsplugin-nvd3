...
class BaseNVD3model(CMSPlugin):
    ...
    chart_type = models.CharField(max_length=30, verbose_name=_('Chart type'), 
                                  ...
                                  default=CHART_TYPES_CHOICES[1][0], choices=CHART_TYPES_CHOICES)
    ...
    container_name = models.CharField(max_length=30, verbose_name=_('Wrapper container id'), 
                                      default='unique', help_text=_('If `unique`, id will be set randomly each time'))
    color_category = models.CharField(max_length=15, help_text=_(''),
                                      verbose_name=_('Color category'), default=COLOR_CATEGORIES[0][0],
                                      blank=True, )
 
    
    #X-axis-properties
    x_is_date = models.BooleanField(default=False, 
                                    verbose_name=_('X-axis is of date-format?'), 
                                    help_text=_('If True, x-axis values will be treated as of date-format'),
                                    blank=True)
    x_date_format = models.CharField(max_length=15, default='%d %b %Y', 
    ...
    ynames = models.TextField(verbose_name='Y-names', help_text=_('Series names separated by commas'))
   
    attrs = models.TextField(blank=True, help_text=_('Additional chart attributes'), 
